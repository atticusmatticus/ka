...
class Equil():
    ...
    def volumeCorrect_addDistance(self, bin_centers, free_energy, delta_x, max_dist):
        ...
        return bin_centers, free_energy, exp_free_energy;
    ...
    def integrateSimpsons(self, r1, r2, delta_x, bin_centers, function):
        Area = 0.
    ...
    def calculateKa(self, wham_file, r1, r2, max_dist):
        ...
        bin_centers, pmf, gr = eq.volumeCorrect_addDistance(bin_centers, pmf, dx, max_dist)

        # make files to plot PMF and g(r).
        eq.makePlotFiles(bin_centers, pmf, gr)
        ...
        numerator_int = eq.integrateSimpsons(0., r1, dx, bin_centers, gr)
        print 'Numerator Integral: ',numerator_int

        #################################################################################
        ## DENOMINATOR in De Jong eqn 44. ("monomer" radii) 

        denominator_int = eq.integrateSimpsons(r1, r2, dx, bin_centers, gr)
    ...
    def boundedIntegral(self, wham_file, r1, r2, max_dist):
        ...
        # Calculate just the integral from De Jong (2011) eqn. 44
        Area = eq.integrateSimpsons(r1, r2, dx, bin_centers, gr)
        print 'Integral: ',Area
...
print '----- Pi-stack dimer -----'
eq.boundedIntegral(wham_file, 0., r1, max_dist)
print '----- Edge-on dimer -----'
eq.boundedIntegral(wham_file, r1, r2, max_dist)
print '----- Monomer dimer -----'
eq.boundedIntegral(wham_file, r2, max_dist, max_dist)
